...
.skill-card .em{font-size:38px;position:relative;z-index:1;filter:drop-shadow(0 3px 6px rgba(0,0,0,.25));
  animation:skillFloat 3s ease-in-out infinite;animation-delay:var(--d,0s)}
@keyframes skillFloat{0%,100%{transform:translateY(0)}50%{transform:translateY(-4px)}}
...
<div id="daily" class="screen">
  ...
  <div class="daily-hero">
    ...
    <p style="color:var(--dim);font-size:12px;margin-top:4px;font-weight:600">Hoàn thành để nhận quà, Uyển Nhi!</p>
  </div>
...
<div id="profile" class="screen">
  <div class="top-bar"><span style="font-weight:800;font-size:15px">👤 Uyển Nhi</span><button class="back-btn" onclick="resetProgress()">🔄 Reset</button></div>
