...
export const GRADE_REGISTRY: GradeEntry[] = [
  { id: 'pre_4', name: 'Bé 4 Tuổi', emoji: '🌸', desc: 'Vườn Cổ Tích · 5 Môn', color: '#f472b6', mascot: '/pets/corgi_level_1.svg', order: 0 },
  { id: 'pre_5', name: 'Bé 5 Tuổi', emoji: '🌟', desc: 'Lâu Đài Ánh Sao · 5 Môn', color: '#a78bfa', mascot: '/pets/cat_level_1.svg', order: 0.5 },
